...
class RerunVisualizer:
    ...
    def __init__(
        ...
        server_memory_limit: str = "16GB",
        collapse_panels: bool = True,
        show_cameras_in_3d_view: bool = False,
        show_camera_point_clouds: bool = True,
        show_ee_camera_point_clouds: bool = True,  # Separate flag for EE camera performance optimization
        show_object_bounding_boxes: bool = False,  # Flag to control 3D object bounding boxes (default OFF)
        output_path=None,
    ):
        ...
        self.show_ee_camera_point_clouds = show_ee_camera_point_clouds
        self.show_object_bounding_boxes = show_object_bounding_boxes
    ...
    def log_ee_camera(self, servo):
        ...
        if self.show_camera_point_clouds and self.show_ee_camera_point_clouds:
    ...
    def update_scene_graph(
        ...
        if semantic_sensor:
            ...
            # Only show 3D object bounding boxes if flag is enabled
            if self.show_object_bounding_boxes:
                log_to_rerun(
                    "world/objects",
                    rr.Boxes3D(
                        half_sizes=bounds,
