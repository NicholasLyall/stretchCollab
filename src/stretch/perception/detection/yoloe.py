...
# Suppress Ultralytics banner during import
@contextmanager
def suppress_ultralytics_output():
    """Context manager to suppress Ultralytics output"""
...
# Set environment variable to suppress Ultralytics output
os.environ['YOLO_VERBOSE'] = 'False'

# Import YOLOE with suppressed output
with suppress_ultralytics_output():
...
class YoloEPerception(PerceptionModule):
    def __init__(
        ...
        # Initialize YOLOE model with suppressed output
        with suppress_ultralytics_output():
