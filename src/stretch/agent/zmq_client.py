...
class HomeRobotZmqClient(AbstractRobotClient):
    ...
    def __init__(
        ...
        show_object_bounding_boxes: bool = False,
    ):
        """
        ...
        if enable_rerun_server:
            ...
            self._rerun = RerunVisualizer(
                ...
                show_object_bounding_boxes=show_object_bounding_boxes
            )
        else:
            self._rerun = None
    ...
    def move_base_to(
        ...
        relative: bool = False,
        blocking: bool = True,
        timeout: float = 30.0,  # Increased timeout for navigation reliability
        verbose: bool = False,
        reliable: bool = True,
    ):
